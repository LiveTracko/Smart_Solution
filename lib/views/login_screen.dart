...
class LoginViewState extends State<LoginView> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color selectedColor = const Color(0xFF356EFF);
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Positioned logo, so it doesn't scroll
          // Positioned(
          //   top: size.height * 0.08, // moved up by decreasing top value
          //   left: (size.width - 250.w) / 2,
          //   child: SvgPicture.asset(
          //     "assets/images/login_logo.svg",
          //     height: 250.h,
          //     width: 250.w,
