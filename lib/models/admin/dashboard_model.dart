...
DasboardModel dasboardModelFromJson(String str) => DasboardModel.fromJson(json.decode(str));
...
class DasboardModel {
    ...
    factory DasboardModel.fromJson(Map<String, dynamic> json) => DasboardModel(
        ...
        gettelecallercallback: Gettelecallercallback.fromJson(json["gettelecallercallback"]),
    );
...
class Getcalllogcount {
    ...
    factory Getcalllogcount.fromJson(Map<String, dynamic> json) => Getcalllogcount(
...
class Gettelecallercallback {
    ...
    factory Gettelecallercallback.fromJson(Map<String, dynamic> json) => Gettelecallercallback(
...
class LoginFileStatus {
    ...
    factory LoginFileStatus.fromJson(Map<String, dynamic> json) => LoginFileStatus(
        activefilecount: json["activefilecount"],
        inactivefilecount: json["inactivefilecount"],
        activeloanamount: json["activeloanamount"],
        inactiveloanamount: json["inactiveloanamount"],
        disbursedfilecount: json["disbursedfilecount"],
