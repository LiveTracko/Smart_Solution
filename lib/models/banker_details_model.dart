...
BankerDetails bankerDetailsFromJson(String str) =>
    BankerDetails.fromJson(json.decode(str));
...
class BankerDetails {
  ...
  factory BankerDetails.fromJson(Map<String, dynamic> json) => BankerDetails(
        data: List<BankerDetailsData>.from(
            json["data"].map((x) => BankerDetailsData.fromJson(x))),
      );
...
class BankerDetailsData {
  ...
  factory BankerDetailsData.fromJson(Map<String, dynamic> json) =>
      BankerDetailsData(
        id: json["id"],
